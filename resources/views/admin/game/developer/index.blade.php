<x-layouts.admin :search="false">
    ...
    <x-common.action-table model-name="admin.game-developers">
        ...
        <x-ui.responsive-table :empty="$developers->isEmpty()">
            ...
            @foreach($developers as $developer)
                <x-ui.responsive-table.row >
                    ...
                    <x-ui.responsive-table.column>
                        <span class="responsive-table__label">{{ trans_choice('common.name', 1) }}: </span> {{ $developer->name }}
                    </x-ui.responsive-table.column>
                    <x-ui.responsive-table.column>
                        <span class="responsive-table__label">{{ trans_choice('user.users', 1) }}: </span> {{ $developer->user_name }}
                    </x-ui.responsive-table.column>
                    <x-ui.responsive-table.column>
                    ...
                    <x-ui.responsive-table.column type="action">
                        <x-common.action-table.buttons :item="$developer" model="admin.game-developers" />
                    </x-ui.responsive-table.column>
                </x-ui.responsive-table.row>
            @endforeach
