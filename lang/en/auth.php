...
return [
    ...
    'verify_title' => 'You need to verify your Email. Check your mail',
    'verify_message' => 'If you have not received the email, request the email again by filling out the form below',
    'verify_retry' => 'Send verify link retry',
    ...
    'username' => 'User name',
    'username_tooltip' => 'The user name must be in lowercase, Latin, and may contain numbers and a sign "."',
